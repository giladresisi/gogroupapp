...
.constant('ACTIVITY_TYPES', ['<בחר סוג פעילות>', 'ריצה', 'כדורסל', 'כדורגל', 'פוקר', 'פלייסטיישן', 'אימהות בחופשת לידה', 'טיול משפחות', 'הרצאה', 'שידור ספורט', 'סדנת יצירה לילדים', 'פעולה בתנועת נוער']);