...
// .constant('ACTIVITY_TYPES', ['ריצה', 'כדורסל', 'כדורגל', 'פלייסטיישן', 'חופשת לידה', 'טיול משפחות', 'הרצאה', 'שידור ספורט', 'יצירה לילדים', 'תנועת נוער']);
.constant('ACTIVITY_TYPES', ['ערב קהילה', 'ארוחת שישי', 'הליכה', 'הקרנת סרט', 'הרצאה', 'ריצה', 'פרשת השבוע']);